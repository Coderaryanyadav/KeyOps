...
class MicrosoftAdapter(PasswordAdapter):
    @property
    ...
    def official_domains(self) -> List[str]:
        return ["microsoft.com", "live.com", "login.live.com", "office.com"]
    ...
    def password_change_url(self) -> str:
        return "https://account.live.com/password/change"
    ...
    async def navigate_to_security(self, page: Page) -> bool:
        ...
        return "live.com" in page.url or "microsoft.com" in page.url
    ...
    async def detect_success(self, page: Page) -> bool:
        ...
        return "password changed" in content.lower()

    async def detect_failure(self, page: Page) -> Optional[str]:
        error_el = await page.query_selector("#error, .alert-error")
        if error_el:
